...
# get rid of bottom 5%
x <-CPF_4[,grepl("_CORR",colnames(CPF_4)) | grepl("PFscores",colnames(CPF_4))]
...
x <-CPF_5[,grepl("_CORR",colnames(CPF_5)) | grepl("PFscores",colnames(CPF_5))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-CPW_2[,grepl("_CORR",colnames(CPW_2)) | grepl("PFscores",colnames(CPW_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-CPW_3[,grepl("_CORR",colnames(CPW_3)) | grepl("PFscores",colnames(CPW_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-SVOLT_2[,grepl("_CORR",colnames(SVOLT_2)) | grepl("PFscores",colnames(SVOLT_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-SVOLT_4[,grepl("_CORR",colnames(SVOLT_4)) | grepl("PFscores",colnames(SVOLT_4))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
# get rid of bottom 5%
x <-ADT30_2[,grepl("_CORR",colnames(ADT30_2)) | grepl("PFscores",colnames(ADT30_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
# get rid of bottom 5%
x <-ADT30_3[,grepl("_CORR",colnames(ADT30_3)) | grepl("PFscores",colnames(ADT30_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-CPF_2[,grepl("_CORR",colnames(CPF_2)) | grepl("PFscores",colnames(CPF_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-CPF_3[,grepl("_CORR",colnames(CPF_3)) | grepl("PFscores",colnames(CPF_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-CPW_1[,grepl("_CORR",colnames(CPW_1)) | grepl("PFscores",colnames(CPW_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <-ER40_1[,grepl("_CORR",colnames(ER40_1)) | grepl("PFscores",colnames(ER40_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- ER40_2[,grepl("_CORR",colnames(ER40_2)) | grepl("PFscores",colnames(ER40_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- ER40_3[,grepl("_CORR",colnames(ER40_3)) | grepl("PFscores",colnames(ER40_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- MEDF_1[,grepl("_CORR",colnames(MEDF_1)) | grepl("PFscores",colnames(MEDF_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- MEDF_2[,grepl("_CORR",colnames(MEDF_2)) | grepl("PFscores",colnames(MEDF_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- MEDF_3[,grepl("_CORR",colnames(MEDF_3)) | grepl("PFscores",colnames(MEDF_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PLOT24_1[,grepl("_CORR",colnames(PLOT24_1)) | grepl("PFscores",colnames(PLOT24_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PLOT24_2[,grepl("_CORR",colnames(PLOT24_2)) | grepl("PFscores",colnames(PLOT24_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PLOT24_3[,grepl("_CORR",colnames(PLOT24_3)) | grepl("PFscores",colnames(PLOT24_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PMAT24_1[,grepl("_CORR",colnames(PMAT24_1)) | grepl("PFscores",colnames(PMAT24_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PMAT24_2[,grepl("_CORR",colnames(PMAT24_2)) | grepl("PFscores",colnames(PMAT24_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PMAT24_3[,grepl("_CORR",colnames(PMAT24_3)) | grepl("PFscores",colnames(PMAT24_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PVRT25_1[,grepl("_CORR",colnames(PVRT25_1)) | grepl("PFscores",colnames(PVRT25_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PVRT25_2[,grepl("_CORR",colnames(PVRT25_2)) | grepl("PFscores",colnames(PVRT25_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- PVRT25_3[,grepl("_CORR",colnames(PVRT25_3)) | grepl("PFscores",colnames(PVRT25_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- SVOLT_1[,grepl("_CORR",colnames(SVOLT_1)) | grepl("PFscores",colnames(SVOLT_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- SVOLT_3[,grepl("_CORR",colnames(SVOLT_3)) | grepl("PFscores",colnames(SVOLT_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- DDISC_1[, grepl(".q_",colnames(DDISC_1)) | grepl("PFscores",colnames(DDISC_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- EDISC_1[,grepl("_resp",colnames(EDISC_1)) | grepl("PFscores",colnames(EDISC_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- RDISC_1[,grepl(".q_",colnames(RDISC_1)) | grepl("PFscores",colnames(RDISC_1))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- DDISC_2[, grepl(".q_",colnames(DDISC_2)) | grepl("PFscores",colnames(DDISC_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- EDISC_2[,grepl("_resp",colnames(EDISC_2)) | grepl("PFscores",colnames(EDISC_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- RDISC_2[,grepl(".q_",colnames(RDISC_2)) | grepl("PFscores",colnames(RDISC_2))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- DDISC_3[, grepl(".q_",colnames(DDISC_3)) | grepl("PFscores",colnames(DDISC_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- EDISC_3[,grepl("_resp",colnames(EDISC_3)) | grepl("PFscores",colnames(EDISC_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
x <- RDISC_3[,grepl(".q_",colnames(RDISC_3)) | grepl("PFscores",colnames(RDISC_3))]
qu <- quantile(x$PFscores,0.05,na.rm=TRUE)
x <- x[which(x$PFscores > qu),]
...
ADT30_1$ADT30_1_CORR <- rowSums(ADT30_1)
ADT30_2$ADT30_2_CORR <- rowSums(ADT30_2)
ADT30_3$ADT30_3_CORR <- rowSums(ADT30_3)
